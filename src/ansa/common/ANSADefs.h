...
#ifndef __ANSA_ANSADEFS_H
#define __ANSA_ANSADEFS_H
...
//
//
#if defined(ANSA_EXPORT)
#  define ANSA_API    OPP_DLLEXPORT
#elif defined(ANSA_IMPORT)
#  define ANSA_API    OPP_DLLIMPORT
#else // if defined(ANSA_EXPORT)
#  define ANSA_API
#endif // if defined(ANSA_EXPORT)
//
...
#endif // ifndef __ANSA_ANSADEFS_H
